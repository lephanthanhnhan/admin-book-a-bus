...
const mockFetchRouteDetails = (routeId: string | number): RouteDetails => {
    const stopsDetails: Stop[] = [
        { id: "1", order: 1, name: 'Bến xe Hà Nội Mỹ Đình', address: 'Tây Sơn, Đống Đa, Hà Nội', arrivalTime: '08:00', departureTime: '08:30', type: 'start' },
        { id: "2", order: 2, name: 'Trạm dừng Thanh Hóa', address: 'Lê Lợi, Thanh Hóa', arrivalTime: '10:15', departureTime: '10:45', type: 'stop' },
        { id: "3", order: 3, name: 'Bến xe TP. Hồ Chí Minh', address: 'Tân Bình, TP. Hồ Chí Minh', arrivalTime: '23:00', departureTime: '23:00', type: 'end' },
    ];
